...
export default {
        ...
        actions: {
            ...
            mp3Obj(context,value) {
                axios.get('https://www.musicapi.space/song/url?id='+value)
                .then(response => {
            ...
            imgObj(context,value) {
                axios.get('https://www.musicapi.space/song/detail?ids='+value)
                .then(response => {
            ...
            pingLun(context,value) {
                axios.get('https://www.musicapi.space/comment/hot?type=0&id='+value)
                .then(response => {
            ...
            // 获取歌词
            lyRic(context,value) {
                axios.get('https://www.musicapi.space/lyric?id='+value)
                .then(response => {
